...
import ru.connect2me.util.hh.parser.helper.Experience;
import ru.connect2me.util.hh.parser.helper.Salary;
import ru.connect2me.util.hh.parser.helper.FullName;
import ru.connect2me.util.hh.parser.helper.Direction;
import ru.connect2me.util.hh.parser.helper.WorkPermit;
import ru.connect2me.util.hh.parser.helper.Education;
import ru.connect2me.util.hh.parser.helper.Address;
import ru.connect2me.util.hh.parser.helper.Trip;
import ru.connect2me.util.hh.parser.helper.Schedule;
import ru.connect2me.util.hh.parser.helper.Skills;
import ru.connect2me.util.hh.parser.helper.Cellphone;
import ru.connect2me.util.hh.parser.helper.Citizenship;
import ru.connect2me.util.hh.parser.helper.Language;
import ru.connect2me.util.hh.parser.helper.Id;
import ru.connect2me.util.hh.parser.helper.Location;
import ru.connect2me.util.hh.parser.helper.Homephone;
import ru.connect2me.util.hh.parser.helper.Email;
import ru.connect2me.util.hh.parser.helper.Birthdate;
import ru.connect2me.util.hh.parser.helper.Relocation;
...
import ru.connect2me.util.hh.parser.config.Module;
import ru.connect2me.util.hh.parser.config.ParserHtmlHhResumeToInhouseXmlException;
import ru.connect2me.util.hh.parser.config.XMLConfiguration;
